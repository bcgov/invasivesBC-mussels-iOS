//
//  ShiftBlowBysCollectionViewCell.swift
//  ipad
//
...
class ShiftBlowBysCollectionViewCell: BaseShiftOverviewCollectionViewCell {
    ...
    static func getContentHeight(for model: ShiftModel) -> CGFloat {
        ...
        let totalVertialTitleSize = dividerHeight + paddings
