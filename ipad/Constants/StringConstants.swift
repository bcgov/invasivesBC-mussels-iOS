...
struct ShiftFormHeaders {
    struct ShiftStart {
        ...
        static let projectDetails = "Project Name, Location and Purpose *"
...
struct WatercraftFieldHeaderConstants {
    struct Passport {
        ...
        static let officerInspection = "Officer Directed Inspection"
    ...
    struct InspectionDetails {
        ...
        static let drainplugRemovedAtInspection = "Was the drain plug already removed when the watercraft arrived at the inspection station? *"
        static let invertedFullyDrained = "Is the boat transported in an inverted manner and all interior compartments are fully drained? *"
    }
...
struct HighRiskFormFieldHeaders {
    ...
    struct InspectionOutcomes {
        ...
        static let decontaminationPerformed = "Decontamination performed? *"
        static let decontaminationReference = "Mussel Prevention Order # *"
        static let decontaminationOrderIssued = "Mussel Prevention Order issued? *"
        static let decontaminationOrderNumber = "Mussel Prevention Order number *"
        static let decontaminationOrderReason = "Reason for issuing Mussel Prevention Order *"
        static let decontaminationAppendixB = "Appendix A completed? *"
